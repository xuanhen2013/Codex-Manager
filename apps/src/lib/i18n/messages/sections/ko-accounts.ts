...
export const KO_ACCOUNTS_MESSAGES: MessageCatalog = {
  ...
  "每次重置会消耗 1 次可用次数，并立即重置当前 Codex 额度窗口。":
    "초기화할 때마다 사용 가능한 횟수 1회를 소모하고 현재 Codex 한도 창을 즉시 초기화합니다.",
  "可用重置次数": "사용 가능한 초기화 횟수",
  "查询中...": "조회 중...",
  "重置次数查询失败": "초기화 횟수를 불러오지 못했습니다",
  "重置次数过期时间": "초기화 횟수 만료 시간",
  "第 {index} 次": "초기화 {index}",
  "重置额度": "한도 초기화",
  "重置中...": "초기화 중...",
  "确认重置额度": "한도 초기화 확인",
  "此操作会消耗 1 次主动重置次数，并立即重置账号 {name} 的 Codex 额度。":
    "수동 초기화 1회를 소모하고 {name} 계정의 Codex 한도를 즉시 초기화합니다.",
  "消耗 1 次并重置": "1회 소모 후 초기화",
  "额度已重置": "한도가 초기화되었습니다",
  "额度重置失败": "한도 초기화 실패",
  "额度重置成功，但刷新部分数据失败": "한도는 초기화되었지만 일부 데이터 새로고침에 실패했습니다",
