...
| Codex 프로젝트 | `app_codex_project_launch` | `direct (데스크톱 전용)` | 파라미터: `path`, `action=start|resume`; Windows/macOS의 `start`는 ChatGPT Codex App 작업 공간을 열고 `resume`은 로컬 CLI 세션 선택기를 사용 |
